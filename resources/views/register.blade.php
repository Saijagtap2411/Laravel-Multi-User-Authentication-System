...
<html lang="en">
    <head>
        ...
        <title>Authentication Pro</title>
                                ...
                                <form action="{{ route('account.processRegister') }}" method="post">
                                    ...
                                    <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="test" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="your full name" >
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="test" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror" name="email" id="email" placeholder="name@example.com" >
